...
@section('title', __('general.social_media.title'))

@section('breadcrumbs')
    <li class="breadcrumb-item active" aria-current="page"><span>{{ __('general.social_media.title') }}</span></li>
@endsection
    ...
    <div class="col-lg-12">
        <div class="statbox widget box box-shadow">
            <div class="widget-content widget-content-area">
                ...
                @can(Acl::PERMISSION_SOCIAL_MEDIA_ADD)
