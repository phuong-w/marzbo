...
@section('title', __('general.schedule.title'))

@section('breadcrumbs')
    <li class="breadcrumb-item active" aria-current="page"><span>{{ __('general.schedule.title') }}</span></li>
@endsection
