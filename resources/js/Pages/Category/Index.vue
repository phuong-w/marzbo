                    ...
                    <tr v-for="(category, index) in categories.data" :key="index">
                        ...
                        <td>
                            <label class="switch s-primary m-0">
                                <input type="checkbox" class="toggle-active" :checked="{true: category.status}" >
                        ...
                        <td class="text-center">
                            <ul class="table-controls">
                                ...
                                <li>
                                    <Link :href="route('admin.category.show', {category: category.id})" class="bs-tooltip"
                                ...
                                <li>
                                    <Link :href="route('admin.category.edit', {category: category.id})" class="bs-tooltip"
                                          data-toggle="tooltip" data-placement="top" title=""
